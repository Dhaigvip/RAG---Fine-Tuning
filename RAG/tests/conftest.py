...
sys.path so `from step04_hybrid_search import ...` resolves, regardless of which
...
Without this, `import step04_hybrid_search` fails with ModuleNotFoundError even
though step04_hybrid_search.py is right there in the project.
"""
